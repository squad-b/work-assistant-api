...
class DefaultRentalValidatorTest {

    @InjectMocks
    DefaultRentalValidator rentalValidator;
    ...
    public void reserve_alreadyReservedBookByOther_ExceptionThrown() throws Exception {
        ...
        //when
        Executable executable = () -> rentalValidator.validateNotExistsOtherMemberReservation(book, member);
